...
public class JInputAssistant{
	...
	private static int            combinationStarter = KeyEvent.META_DOWN_MASK;
	private        JPopupMenu     leftClickPopUp;
	private        JMenuItem      cut;
	private        JMenuItem      copy;
	private        JMenuItem      paste;
	private        JMenuItem      clearAll;
	private        JMenuItem      selectAll;
	private        JMenuItem      cutAll;
	 ...
	 * @author HomeletWei
	 */
	JInputAssistant(JTextComponent parent){
	...
	public static void setCombinationStarter(int combinationStarter){
		JInputAssistant.combinationStarter = combinationStarter;
	}
	...
	private void addLeftClickDropDownAction(){
		...
		properties.addActionListener((e)->{
			int letterCount = JInputUtility.getLetterCount(parent);
			int wordCount   = JInputUtility.getWordCount(parent);
			int charCount   = JInputUtility.getCharacterCount(parent);
